"""
Django settings for djangolabadmin project.
...
ROOT_URLCONF = 'djangolabadmin.urls'
...
WSGI_APPLICATION = 'djangolabadmin.wsgi.application'
...
MEDIA_ROOT = '/www/djangolabadmin/uploads/'
STATIC_ROOT = '/www/djangolabadmin/static/'
